...
export const infoOptionItem = {
  ...
  svg: false,
  icon: 'el-icon-info',
  componentRender: () => import('@/themes/pos/components/ADempiere/Field/FieldOptions/ContextInfo')
}
...
export const zoomInOptionItem = {
  ...
  svg: false,
  icon: 'el-icon-files',
  componentRender: () => import('@/themes/pos/components/ADempiere/Field/FieldOptions/EmptyOption')
}
...
export const operatorOptionItem = {
  ...
  svg: false,
  icon: 'el-icon-rank',
  componentRender: () => import('@/themes/pos/components/ADempiere/Field/FieldOptions/OperatorComparison')
}
...
export const translateOptionItem = {
  ...
  svg: true,
  icon: 'language',
  componentRender: () => import('@/themes/pos/components/ADempiere/Field/FieldOptions/TranslatedField')
}
...
export const calculatorOptionItem = {
  ...
  componentRender: () => import('@/themes/pos/components/ADempiere/Field/FieldOptions/CalculatorField')
}
...
export const preferenceValueOptionItem = {
  ...
  componentRender: () => import('@/themes/pos/components/ADempiere/Field/FieldOptions/PreferenceValue')
}
...
export const logsOptionItem = {
  ...
  svg: true,
  icon: 'tree-table',
  componentRender: () => import('@/themes/pos/components/ADempiere/Field/FieldOptions/ChangeLogs')
}
...
export const documentStatusOptionItem = {
  ...
  svg: false,
  icon: 'el-icon-set-up',
  componentRender: () => import('@/themes/pos/components/ADempiere/Field/FieldOptions/DocumentStatus')
}

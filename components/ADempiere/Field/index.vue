...
import FieldOptions from '@/themes/pos/components/ADempiere/Field/FieldOptions/index.vue'
  ...
  computed: {
    ...
    componentRender() {
      if (this.isEmptyValue(this.field.componentPath || !this.field.isSupported)) {
        return () => import('@/themes/pos/components/ADempiere/Field/FieldText')
      }
      if (this.isSelectCreated) {
        return () => import('@/themes/pos/components/ADempiere/Field/FieldSelectMultiple')
      }
      let field
      switch (this.field.componentPath) {
        case 'FieldAutocomplete':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldAutocomplete')
          break
        case 'FieldBinary':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldBinary')
          break
        case 'FieldButton':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldButton')
          break
        case 'FieldColor':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldColor')
          break
        case 'FieldDate':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldDate')
          break
        case 'FieldImage':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldImage')
          break
        case 'FieldLocation':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldLocation')
          break
        case 'FieldLocator':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldLocator')
          break
        case 'FieldNumber':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldNumber')
          break
        case 'FieldSelect':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldSelect')
          break
        case 'FieldText':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldText')
          break
        case 'FieldTextLong':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldTextLong')
          break
        case 'FieldTime':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldTime')
          break
        case 'FieldYesNo':
          field = () => import('@/themes/pos/components/ADempiere/Field/FieldYesNo')
          break
      }
      return field
    },

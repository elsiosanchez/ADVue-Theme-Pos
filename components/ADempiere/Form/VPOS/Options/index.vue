...
import OrdersList from '@/themes/pos/components/ADempiere/Form/VPOS/OrderList/index'
import ConfirmDelivery from '@/themes/pos/components/ADempiere/Form/VPOS/ConfirmDelivery'
import orderLineMixin from '@/themes/pos/components/ADempiere/Form/VPOS/Order/orderLineMixin.js'
...
import ModalDialog from '@/themes/pos/components/ADempiere/Dialog'
import GeneralOptions from '@/themes/pos/components/ADempiere/Form/VPOS/Options/generalOptions.vue'
  ...
  computed: {
    ...
    isComponentRender() {
      ...
      switch (true) {
        case this.showCashOpen:
        case this.showMoneyIncome:
          component = () => import('@/themes/pos/components/ADempiere/Form/VPOS/Options/CashOpening')
          this.clearField('Cash-Opening')
          break
        case this.showCashWithdrawl:
        case this.showTransfer:
          component = () => import('@/themes/pos/components/ADempiere/Form/VPOS/Options/Cashwithdrawal')
          this.clearField('Cash-Withdrawal')
          break
        case this.showCashSummaryMovements:
          component = () => import('@/themes/pos/components/ADempiere/Form/VPOS/Options/CashSummaryMovements')
          break
        case this.showAssignSeller:
        case this.showUnassignSeller:
          component = () => import('@/themes/pos/components/ADempiere/Form/VPOS/Options/AssignSeller')
          break
      }
      return component
    },

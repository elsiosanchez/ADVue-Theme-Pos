    ...
    renderDashboard() {
      ...
      if (this.metadata.dashboardType === 'dashboard') {
        switch (this.metadata.fileName) {
          case 'recentItems':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/recentItems')
            break
          case 'userfavorites':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/userfavorites')
            break
          case 'docstatus':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/docstatus')
            break
          default:
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/calendar')
            break
        }
      } else {
        switch (this.metadata.chartType) {
          //  Bar Chart
          case 'BC':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/charts/BarChart')
            break
          //  Area Chart
          case 'AC':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/charts/AreaChart')
            break
          //  Line Chart
          case 'LC':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/charts/LineChart')
            break
          //  Pie Chart
          case 'PC':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/charts/PieChart')
            break
          //  Ring Chart
          case 'RC':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/charts/PieChart')
          ...
          //  Raddar Chart
          case 'RA':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/charts/RaddarChart')
            break
          //  Waterfall Chart
          case 'WC':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/charts/WaterfallChart')
            break
          //  Basic Scatter Chart
          case 'SC':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/charts/Scatter')
            break
          //  Gauge
          case 'GU':
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/charts/Gauge')
            break
          default:
            dashboard = () => import('@/themes/pos/components/ADempiere/Dashboard/charts/LineChart')
            break
